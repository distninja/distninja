...
[![Docker](https://img.shields.io/docker/pulls/craftslab/distninja)](https://hub.docker.com/r/craftslab/distninja)
...
```bash
# Build image
docker build -f Dockerfile -t craftslab/distninja:latest .
